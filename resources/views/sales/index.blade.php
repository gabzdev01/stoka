...
<style>
    ...
    .cat-tab.active { color: #1C1814; border-bottom-color: #1C1814; }
    ...
    .cat-more-dropdown {
        ...
        min-width: 160px;
        z-index: 110;
        box-shadow: 0 8px 28px rgba(28,24,20,0.14);
    }
    ...
    .cat-more-item.active { color: #1C1814; font-weight: 600; }
    .cat-more-item:active { background: rgba(28,24,20,0.04); }
    ...
    .pay-btn:active { opacity: 0.80; }
    .pay-btn .pay-btn-arrow { opacity: 0.5; font-size: 16px; }
    .pay-btn.cash   { background: #1C1814; color: rgba(255,255,255,0.88); }
    .pay-btn.mpesa  { background: #4A6741; color: rgba(255,255,255,0.92); }
    .pay-btn.credit { background: transparent; border: 1.5px solid rgba(193,127,74,0.4); color: #A06830; }
    .pay-btn.credit .pay-btn-arrow { color: #C17F4A; }
    ...
    .sale-toast.show { opacity: 1; transform: translateX(-50%) translateY(0); }
        ...
        @media (min-width: 480px) {
            ...
            .receipt-modal   { border-radius: 24px !important; max-width: 380px; }
        }
        ...
        .ro-rule {
            border: none;
            border-top: 1px solid rgba(28,24,20,0.07);
            margin: 0 0 20px;
        }
        ...
        .ro-btn-new:active { opacity: 0.78; }

        /* keep ro-summary hidden — amount/payment replace it */
        .ro-summary { display: none; }
        .ro-title   { display: none; }
</style>
@endsection
...
<div class="bottom-sheet" id="cart-sheet">
    ...
    <div class="sheet-screen hidden" id="cart-screen-checkout">
        ...
        <span class="pay-label">How are they paying?</span>

        <button type="button" class="pay-btn cash"   onclick="selectCartPayment('cash')">
            <span>Cash</span><span class="pay-btn-arrow">&#8594;</span>
        </button>
        <button type="button" class="pay-btn mpesa"  onclick="selectCartPayment('mpesa')">
...
<div class="receipt-overlay" id="receipt-overlay">
    <div class="receipt-modal">
        ...
        <div class="ro-check">
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="30 9 15 26 6 18"/>
            </svg>
        </div>

        <div class="ro-amount" id="ro-amount"></div>
        <div class="ro-payment-label" id="ro-payment-label"></div>

        {{-- hidden compat elements --}}
        <div class="ro-summary" id="ro-summary"></div>
        <div class="ro-title"></div>

        <hr class="ro-rule" id="ro-rule" style="display:none">

        <a class="ro-btn ro-btn-wa" id="ro-wa-btn" href="#" target="_blank" rel="noopener" style="display:none">
        ...
        <a class="ro-btn ro-btn-print" id="ro-print-btn" href="#" target="_blank" rel="noopener" style="display:none">
        ...
        <button class="ro-btn-new" onclick="closeReceiptOverlay()">
            New sale <span style="opacity:0.5">&#8594;</span>
        </button>
...
(function () {
    ...
    function showReceiptOverlay(data) {
        ...
        // Legacy summary (hidden but keep for compat)
        ...
        if (waBtn) {
            if (receiptDigital) {
                ...
                document.getElementById('ro-rule').style.display = 'block';
            } else {
