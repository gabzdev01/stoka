...
<div class="app-banner">
    @if(session('auth_role') === 'owner')
        ...
        <span class="sep">·</span>
        <a href="{{ route('settings.index') }}">Manage shop</a>
    @else
...
.app-banner a { color: rgba(255,255,255,0.45); text-decoration: none; transition: color 0.12s; }
.app-banner a:hover { color: rgba(255,255,255,0.85); }
.app-banner .sep { color: rgba(255,255,255,0.15); }
</style>
...
<div class="shop-header">
    ...
    <div class="shop-location">{{ $tenant->shop_location }}</div>
    @endif
</div>
