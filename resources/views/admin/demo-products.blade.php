...
<div class="main">
  <div class="page-header">
    <div><h1 class="page-title">Demo Products</h1><p class="page-sub">Manage what appears in the demo shop. You control everything — images, prices, visibility.</p></div>
    <a href="/admin/demo-products/create" class="btn-primary">+ Add Product</a>
  </div>
    ...
    <div class="table-card">
      ...
      <div class="row-item">
        ...
        <div class="row-actions" style="align-items:center;gap:10px;">
          ...
          <a href="/admin/demo-products/{{ $p->id }}/edit" class="btn-ghost" style="font-size:11px;">Edit</a>
          <form method="POST" action="/admin/demo-products/{{ $p->id }}/toggle" style="display:inline;">
